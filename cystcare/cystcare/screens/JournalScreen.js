...
const JournalScreen = ({ navigation }) => {
  const Journalroute = useRoute();
  const { title } = Journalroute.params || {};
      ...
      <View style={styles.header}>
        <View style={styles.dpCover}>
          ...
          <View style={{ flexDirection: "column", left: 15, width: 160 }}>
            <Text style={{ fontSize: 25, color: colors.white }}>Hi there!</Text>
            <Text style={{ fontSize: 18, marginTop: 5, color: colors.white }}>
